...
public class ServerPage extends javax.swing.JFrame {
    ...
    try{
            ...
            ResultSet rs = stmt.executeQuery("select  * from servertable where id="+jTextField1.getText());
            if(rs.next()){
             String name =rs.getString("Name");
             String connect =rs.getString("Connection type");
             String number =rs.getString("Number");
             String location =rs.getString("Location");
             jTextField2.setText(name);
             jTextField3.setText(connect);
